...
from attention_train import optimize_model_parameters_attention
...
# 数据路径
data_dir = "C:/Users/吴睿涵/Desktop/files/academic/大三下/计算机视觉/lab_data"
...
model, best_model, history_train_losses, history_train_accuracies, history_val_losses, history_val_accuracies = optimize_model_parameters_attention(
    network=model,
...
# 保存最佳模型
store_model_parameters(best_model, "best_model_relu_attention")
