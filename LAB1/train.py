...
def optimize_model_parameters(network, training_data, training_labels, validation_data, validation_labels, lr_initial, lr_decay, regularisation_strength, total_epochs, samples_per_batch, activation_fn='leaky_relu'):
